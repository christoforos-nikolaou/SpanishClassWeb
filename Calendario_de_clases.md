...
- **martes, 11 de noviembre**: Practica de expresión escrita - Lectura.    
  ...
  - _C1. Examen2. Prueba 1. Tareas 1-5. p. 30-39._
  - _Tarea: Expresión Escrita. Una pelicula que me ha gustado._  
    
- **jueves, 13 de noviembre**: Test de expresión escrita. 
  - _Hicimos un auditivo de práctica: Claves C1. Unidad 2, Parte 1. Servicios de una ciudad real :headphones: [link](https://github.com/christoforos-nikolaou/SpanishClassWeb/blob/main/Recursos_auditivos.md/#13-de-noviembre)._ 
  - _Escibimos un test de expresión escrita: C1. Examen2. Prueba 3. Tarea 2. Opción 1. p. 44._
  
- **martes, 18 de noviembre**: "Claves C1", Unidad 2, Partes 4 y 5. p. 42-44.   
    * _Hablamos de vocabulario de medios de comunicación, vocabulario de vivienda y anuncios clasificados._

- **jueves, 20 de noviembre**: "Claves C1", Unidad 2, Partes 6 a 10. p. 45-50.  
    * _Gramática: Expresiones con subjuntivo. Conectores consecutivos y causales._        
    * _Vocabulario: Funciones del estado, vocabulario de justicia y constitución._  
    * _Audición: [Partes 6 y 9](https://github.com/christoforos-nikolaou/SpanishClassWeb/blob/main/Recursos_auditivos.md/#20-de-noviembre)_   
