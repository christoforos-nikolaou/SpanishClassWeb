...
- :calendar: El [calendario de clases](https://github.com/christoforos-nikolaou/SpanishClassWeb/blob/main/Calendario_de_clases.md), con detalles sobre las cosas que aprendemos en cada clase y sesión.
- :notebook: Información sobre las [tareas y ejercicios](https://github.com/christoforos-nikolaou/SpanishClassWeb/blob/main/Tareas_y_ejercicios.md).
